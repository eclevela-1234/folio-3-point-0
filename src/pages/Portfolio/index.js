...
function Portfolio() {
  ...
  const photos = [
    ...
    },
    {
      ...
      description: "An interactive dashboard created using Plotly.js to bring to life sales and weather data. This was a final broject for my data analysis boot camp. Used Pandas to clean data and a variety of software packages for exploratory data analysis. As I dive back into business analytics, I plan to create web apps with similar utility but with authentication and a more responsive front end by applying concepts learned in the Web Dev Program.",
